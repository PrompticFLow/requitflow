...
import { Loader2, Mail, Users, Check, RefreshCw, Save, AlertTriangle, CheckCircle2, X, Search } from "lucide-react";
           ...
           <div className="glass p-8 rounded-2xl border border-slate-700/50">
             ...
             {campaignData?.offer && (
               <div className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-6 mb-6">
                 <h4 className="text-white font-bold mb-2">Offer</h4>
                 <p className="text-sm text-slate-300">{campaignData.offer}</p>
               </div>
             )}
